...
class ucIOSSDK{
    ...
    function getUCBaseInit(){
        require_once dirname(__FILE__).'/ucIOS/service/SDKServerService.php';
        require_once dirname(__FILE__).'/ucIOS/model/SDKException.php';
    }


    function getUCPayInit(){
        require_once dirname(__FILE__).'/ucIOS/util/ConfigHelper.php';
        require_once dirname(__FILE__).'/ucIOS/util/LoggerHelper.php';
    }
